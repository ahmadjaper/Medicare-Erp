    ...
    <div className="top-navbar-actions text-end d-flex align-items-center justify-content-end gap-2 ms-auto position-relative">
      ...
      <div ref={searchRef} className="search-wrapper position-relative text-start">
        ...
        {showSearchResults && searchVal && (
          <div className="card shadow-lg border-secondary-subtle position-absolute top-100 start-0 mt-1 w-100 p-2 overflow-y-auto" style={{ zIndex: 1000, maxHeight: '350px', width: '380px', borderRadius: '8px' }}>
      ...
      <div className="position-relative">
        ...
        {showUserMenu && (
          <div className="card shadow-lg border-secondary-subtle position-absolute end-0 mt-2 p-2" style={{ zIndex: 1000, width: '180px', borderRadius: '8px' }}>
            <div className="px-2 py-1 text-muted border-bottom fw-bold text-start" style={{ fontSize: '0.75rem' }}>Profile Actions</div>
            <div className="d-flex flex-column text-start mt-1">
              <button className="btn btn-sm text-start hover-bg-light" style={{ fontSize: '0.8rem' }} onClick={() => { navigate('/settings'); setShowUserMenu(false); }}><i className="bi bi-person me-2"></i> Settings</button>
